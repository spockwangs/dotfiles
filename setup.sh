...
for name in bash_profile bashrc clang-tidy dir_colors emacs.d fonts.conf gitconfig gitignore gnomerc indent.pro inputrc screenrc sqlfluff tmux.conf zshrc; do
    ln -snf "${CWD}/$name" "${HOME}/.${name}"
done
